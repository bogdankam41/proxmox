...
| -------------- | ---- | -------------- | ------- | ------------------- |
| `k3s-master`   | 200  | 192.168.1.30   | 2048 MB | `BC:24:11:A0:30:30` |
| `k3s-worker-1` | 201  | 192.168.1.31   | 1536 MB | `BC:24:11:A0:30:31` |
| `k3s-worker-2` | 202  | 192.168.1.32   | 1536 MB | `BC:24:11:A0:30:32` |
